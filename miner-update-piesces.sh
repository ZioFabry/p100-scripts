...
if [[ $service == 'start' ]]; then
  ...
  if [[ $currentdockerstatus =~ 'Exited' || $currentdockerstatus == '' ]]; then
    ...
    curl -Lf https://raw.githubusercontent.com/ZioFabry/p100-scripts/main/sys.config -o /home/pi/hnt/miner/configs/sys.config >> /var/dashboard/logs/miner-update.log
